...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PlayerBattingCareer'
        db.create_table('mlb_playerbattingcareer', (
        ...
        db.send_create_signal('mlb', ['PlayerBattingCareer'])


    def backwards(self, orm):
        
        # Deleting model 'PlayerBattingCareer'
        db.delete_table('mlb_playerbattingcareer')
