...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PlayerBattingSeason'
        db.create_table('mlb_playerbattingseason', (
        ...
        db.send_create_signal('mlb', ['PlayerBattingSeason'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'PlayerBattingSeason'
        db.delete_table('mlb_playerbattingseason')
